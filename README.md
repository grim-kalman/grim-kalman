...
|  **6**  |     |     |     |     |     |     |     |     |
|  **5**  |     |     |  _p_  |     |     |     |     |     |
|  **4**  |     |     |     |     |  [**P**](http://localhost:8080/api/chess/select?square=e4)  |     |  [_](http://localhost:8080/api/chess/play?move=g2g4)  |     |
...
>
> $\texttt{\color{Orchid}2024-05-09 16:02:01}$ $\texttt{Match in progress. Your move...}$