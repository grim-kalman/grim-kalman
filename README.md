...
|  **6**  |     |     |     |     |     |     |     |     |
|  **5**  |     |     |  _p_  |  _p_  |     |     |     |     |
|  **4**  |  [**P**](http://localhost:8080/api/chess/select?square=a4)  |  _n_  |     |     |  [**P**](http://localhost:8080/api/chess/select?square=e4)  |  [**P**](http://localhost:8080/api/chess/select?square=f4)  |     |     |
|  **3**  |  [**N**](http://localhost:8080/api/chess/select?square=a3)  |     |     |     |     |     |     |     |
|  **2**  |     |     |  [**P**](http://localhost:8080/api/chess/select?square=c2)  |  [**P**](http://localhost:8080/api/chess/select?square=d2)  |     |     |     |  [**P**](http://localhost:8080/api/chess/select?square=h2)  |
